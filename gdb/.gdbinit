source /home/yun/pwndbg/gdbinit.py
set context-clear-screen on
set context-ghidra if-no-source
set follow-fork-mode parent
source /home/yun/tmp/splitmind/gdbinit.py
python
import splitmind
(splitmind.Mind()
  ...
  .above(display="ghidra" , size="30%")
).build(nobanner=True)
end
set context-code-lines 30
set context-source-code-lines 30
set context-sections  "regs args code disasm stack backtrace ghidra"
